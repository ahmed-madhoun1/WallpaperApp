...
class NetworkMonitor @Inject constructor(@ApplicationContext context: Context, @ActivityScoped activity: Activity) {

    private var mContext = context
    val DISMIS_SNACKBAR = 0
    var snackbar = Snackbar.make(
        activity.findViewById(android.R.id.content),
        activity.getString(R.string.text_check_internet_connection),
